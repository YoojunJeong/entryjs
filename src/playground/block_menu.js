...
class BlockMenu {
    ...
    generaterPlayerHideShowIcon () {
        ...
        function showPlayer() {
            ...
            $(".entryWorkspaceBlockMenu").removeClass("moveUp");
            $(".entryWorkspaceBlockMenu").addClass("moveDown");

            setTimeout(() => {
                $("#videoPlayerShowBtnContainer").hide();
                Entry.windowResized.notify()
            }, 500);
            $("#videoPlayerShowBtnContainer").addClass("disappear");
            $("#videoPlayerShowBtnContainer").removeClass("appear");
        }
        ...
        function hidePlayer() {
            ...
            setTimeout(() => {
                ...
                $("#videoPlayerShowBtnContainer").removeClass("disappear");
                $("#videoPlayerShowBtnContainer").addClass("appear");

                $("#entryMenuTop").hide()
                Entry.windowResized.notify()
            }, 500);

            $(".entryWorkspaceBlockMenu").removeClass("moveDown");
            $(".entryWorkspaceBlockMenu").addClass("moveUp");
